...
Сделан [форк](https://github.com/ryzhakovks/example-teamcity.).
...
Согласно заданию, была создана доп ветка `feature/add_reply` в репозитории https://github.com/ryzhakovks/example-teamcity.  Дописан метод для класса Welcomer и тест для него (см. ниже):
...
Cсылка на репозиторий https://github.com/ryzhakovks/example-teamcity. <br>
